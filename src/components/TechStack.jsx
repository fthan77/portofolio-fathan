...
const content = {
  id: {
    ...
    title: "BAHASA &",
    titleOutline: "TEKNOLOGI",
    levelMap: { "Mahir": "Mahir", "Menengah": "Menengah", "Dasar": "Dasar" },
  },
  en: {
    eyebrow: "// 03 — TECH STACK",
    title: "LANGUAGES &",
    titleOutline: "TECHNOLOGY",
    levelMap: { "Mahir": "Advanced", "Menengah": "Intermediate", "Dasar": "Basic" },
  },
};

function StackCard({ item, lang }) {
  const levelMap = content[lang].levelMap;
  return (
    <div className="stack-card bg-background p-4 flex flex-col items-center gap-2 text-center hover:bg-surface transition-colors">
      ...
      <div className="font-mono text-xs text-on-surface-variant">{levelMap[item.level] || item.level}</div>
